...
from utilsTest import get_frame_index,get_srt_timestamp
...
class Video:
    ...
    def get_subtitles(self, sim_threshold: int) -> str:
        ...
        return ''.join(
            '{}\n{}\n'.format(
                get_srt_timestamp(sub.index_start, self.fps),
                # get_srt_timestamp(sub.index_end, self.fps),
                sub.text)
